...
<head>
  ...
  <title>List Car - Adhisty_NIM</title>
...
<body>
  ...
  <nav class="navbar navbar-expand-lg bg-primary">
    <div class="container">
      <div class="collapse navbar-collapse d-flex justify-content-between" id="navbarNavAltMarkup">
        ...
        <a href="Add-Adhisty.php" style="background-color: white; color:blue; border-radius: 5px; text-decoration: none; width: 150px; height: 35px; display:flex; justify-content:center; align-items:center; font-weight:500;">Add Car</a>
      </div>
    </div>
  </nav>
  <!-- Nav End -->
  ...
  <section id="list">
    <div class="container">
      <div>
        <h1>My Show Room</h1>
        <p>List Mobil ShowRoom Adhisty</p>
        <div class="d-flex gap-5">
          ...
          if (mysqli_num_rows($hasil) > 0) {
            ...
            <div class='card-body'>
              ...
              <span class='d-flex'>
                <a href='Detail-Adhisty.php?id=" . $row["id_mobil"] . "' class='btn btn-primary' style='border-radius: 100px; width:140px; height: 36px;'>Detail</a>
