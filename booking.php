                    ...
                    <div class="col">
                        <?php
                         if(isset($_GET['mobil'])){
                            ...
                            echo '<img width="350" height="250" src=image/mobil alphard.jpg></img>';
                            }
                            elseif($_GET['mobil']=='camry'){
                                echo '<img width="350" height="250" src=image/mobil camry.jpeg></img>';
                            }
                            elseif($_GET['mobil']=='jazz'){
                              echo '<img width="350" height="250" src=image/mobil jazz.jpg></img>';
                            }
                         }
                            else{
                            echo '<img width="350" height="250" src=image/mobil alphard.jpg></img>';
