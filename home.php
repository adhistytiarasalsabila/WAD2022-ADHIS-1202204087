    ...
    <section>
        <div class="container-md" style="margin-left: auto; margin-right:auto; max-width : 80%">
            ...
            <div class="card h-100">
                <img src="image/mobil alphard.jpg" class="card-img-top" alt="Relevant Car Photo 1">
                <div class="card-body">
            ...
            <div class="card h-100">
                <img src="image/mobil camry.jpeg" class="card-img-top" alt="Relevant Car Photo 1">
                <div class="card-body">
            ...
            <div class="card h-100">
                <img src="image/mobil jazz.jpg" class="card-img-top" alt="Relevant Car Photo 1">
                <div class="card-body">
